+++
title = "Страдательный залог = Edilgen Çatı"
level = "A2"
draft = false
url = '/dopolnitelnaya-teoriya/stradatelnyi-zalog/'
aliases = ['/drugaya-teoriya/stradatelnyi-zalog/']
+++
Коротко: что означает и как использовать «Страдательный залог = Edilgen Çatı».
